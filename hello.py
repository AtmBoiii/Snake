...
def draw_objects():
    ...
    pygame.draw.rect(win, ORANGE, pygame.Rect(food_pos[0], food_pos[1], BLOCK_SIZE, BLOCK_SIZE))
    # Render the score
...
def game_over_screen():
    ...
    game_over_text = game_over_font.render(f"Game Over! Score: {score}", True, CYAN)
